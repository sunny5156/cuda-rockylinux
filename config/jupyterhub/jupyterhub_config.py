...
c.GenericOAuthenticator.oauth_callback_url = 'http://10.100.1.239:8888/hub/oauth_callback'
c.GenericOAuthenticator.token_url = 'http://10.100.0.15:8000/api/login/oauth/access_token'
c.GenericOAuthenticator.authorize_url = 'http://10.100.0.15:8000/login/oauth/authorize'
c.GenericOAuthenticator.userdata_url = 'http://10.100.0.15:8000/api/get-account'
...
#c.ConfigurableHTTPProxy.api_url = 'http://10.100.1.239:8000'

#c.JupyterHub.base_url = '/'
c.JupyterHub.hub_ip = '10.100.1.239'
##c.JupyterHub.port = 8000
##c.JupyterHub.hub_port = 8080
#c.JupyterHub.bind_url = 'http://:8888'
c.JupyterHub.bind_url = 'http://10.100.1.239:8888'
##c.JupyterHub.hub_connect_ip = '10.100.1.239'
#c.JupyterHub.default_url = '/hub/home'

c.JupyterHub.redirect_to_server = False
c.JupyterHub.debug_proxy = False

#c.JupyterHub.proxy_api_ip = '10.100.1.239'
...
notebook_dir = os.environ.get('DOCKER_NOTEBOOK_DIR') or '/home/super'
c.DockerSpawner.notebook_dir = notebook_dir
c.DockerSpawner.volumes = { '/data/aistudio/{username}': notebook_dir }
c.DockerSpawner.extra_create_kwargs = {
   'user': 'super', # Can also be an integer UID
   'hostname': 'aistudio-{username}'
}
...
c.DockerSpawner.hub_connect_url = 'http://10.100.1.239:8081'
